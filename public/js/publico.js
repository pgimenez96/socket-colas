...
socket.on('estado-actual', ( payload ) => {
    ...
    /**
     * Se acciona un botón oculto para reproducir el audio
     * ya que en el navegador google chrome valida que solo
     * se reproduzcan audios por interacción del usuario
     */
...
document.querySelector('#btnAudio').addEventListener('click', () => {
    // Reproduce audio
